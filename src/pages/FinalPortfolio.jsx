...
// Komponen Pembantu untuk Animasi Scroll
  ...
  useEffect(() => {
    const type = () => {
        ...
        if (isDeleting.current) {
            displayText = currentWord.substring(0, charIndex.current - 1);
            charIndex.current--;
        } else {
            displayText = currentWord.substring(0, charIndex.current + 1);
            charIndex.current++;
        ...
        if (!isDeleting.current && charIndex.current === currentWord.length + 1) {
    ...
    const typingInterval = setInterval(type, isDeleting.current ? 80 : 150);
...
const FinalPortfolio = () => {
  ...
  const portfolioData = {
    techSkills: [
        ...
        { name: 'React', icon: 'fa-brands fa-react' }, { name: 'C#', icon: 'fa-solid fa-code' }, { name: 'Unity', icon: 'fa-brands fa-unity' }
    ],
    certifications: [
  ...
  return (
    <div className="bg-dark-bg text-dark-font font-inter overflow-x-hidden animate-fade-in" style={{ scrollBehavior: 'smooth' }}>
        ...
        <footer className="border-t border-dark-border py-8 text-center">
            <div className="container mx-auto px-4 md:px-8">
                <div className="flex justify-center gap-6 mb-4">
                    ...
                    <a href="https://github.com/yayangurayan" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-dark-font-secondary hover:text-primary-1-dark transition-colors text-2xl"><i className="fab fa-github"></i></a>
                </div>
