...
const socialLinks = [
  {
    ...
    icon: `[Ikon SVG GitHub]`, // Placeholder
  },
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/in/andrian-kho-947a97264',
    icon: `[Ikon SVG LinkedIn]`, // Placeholder
  },
]
    ...
    <div class="relative isolate overflow-hidden py-24 sm:py-32">
      <div class="mx-auto grid max-w-7xl grid-cols-1 gap-x-16 gap-y-16 px-6 lg:grid-cols-2 lg:px-8">
        ...
        <div class="max-w-xl lg:max-w-lg">
          <span class="font-mono text-sm uppercase text-primary">Hubungi Saya</span>
          ...
          <p class="mt-4 text-lg leading-8 text-text-main/70">
            Saya selalu terbuka untuk mendiskusikan proyek baru, peluang *freelance*, atau ide
            menarik lainnya. Jangan ragu untuk mengirim saya pesan.
          </p>
          ...
          <div class="mt-10 flex items-center gap-x-6 border-t border-white/10 pt-8">
            <span class="font-mono text-sm text-text-main/50">Follow saya:</span>
            <a
            ...
            >
              ...
              <!-- Ganti dengan ikon SVG GitHub/LinkedIn nanti -->
        ...
        >
          <h2 class="font-poppins text-2xl font-semibold text-text-main">Kirim saya pesan</h2>
          <FormField
